...
class Constants {
	...
	struct Core {
		static let APP_ID = "1463531667"
		static let APP_NAME = "Grow Tasks"
	}
    ...
    struct AppGroup {
        static let NAME = "group.com.rnuhrxljnlgrowuptaskhealthytracker.app"
    }
	...
	struct Strings {
		...
		// Links
		static let LINK_APP_REVIEW = "itms-apps://itunes.apple.com/app/id" + Core.APP_ID + "?action=write-review"
		static let LINK_INSTAGRAM = "https://www.instagram.com/joeytawadrous"
		static let LINK_IOS_STORE = "https://itunes.apple.com/us/app/Grow-Tasks/id1463531667?mt=8"
        
		static let LINK_PRIVACY = "https://www.getLearnable.com/privacy.php"
		static let LINK_TERMS = "https://www.getLearnable.com/terms.php"
		static let LINK_LEARNABLE_IOS_STORE = "https://github.com/Rnuhrxljnl/GrowTasks"
		static let LINK_TWITTER = "https://twitter.com/getlearnable"
		static let LINK_TWITTER_JOEY = "https://github.com/Rnuhrxljnl"
		...
		// Send Feedback
		static let EMAIL = "oufen9371171337@yeah.net"
		static let SEND_FEEDBACK_SUBJECT = "Grow Tasks Feedback!"
		static let SEND_FEEDBACK_BODY = "I want to make Grow Tasks better. Here are my ideas... \n\n What I like about Grow Tasks: \n 1. \n 2. \n 3. \n\n What I don't like about Grow Tasks: \n 1. \n 2. \n 3. \n\n"
		
		
		// Share
		static let SHARE = "Check out " + Constants.Core.APP_NAME + " on the App Store, where you can easily create goals and tasks to achieve those goals! #Grow Tasks #iOS \n\nDownload for free now: " + Constants.Strings.LINK_IOS_STORE
	}
